...
//    };
    ...
    std::vector<line_t> lines_a = {
        {{200 - 10, 150 + 20 - 10}, {200 + 20 - 10, 150 + 20 - 10}},
        {{200 - 10 + 20, 150 + 20 - 10}, {200 + 20 - 10, 150 - 10}},
        {{200 - 10 + 20, 150 - 10}, {200 - 10, 150 - 10}},
        {{200 - 10, 150 - 10}, {200 - 10, 150 + 20 - 10}},
    };
    std::vector<node_t> bsp_a = build(lines_a);

    std::vector<line_t> lines_b = {
        {{200, 150 + 20}, {200 + 20, 150 + 20}},
        {{200 + 20, 150 + 20}, {200 + 20, 150}},
        {{200 + 20, 150}, {200, 150}},
        {{200, 150}, {200, 150 + 20}},
    };
    std::vector<node_t> bsp_b = build(lines_b);

    auto bsp = bsp_union(bsp_a, bsp_b);
